...
- AsyncTask 설명
  ...
  - AsyncTask 는 3가지 Generic Type 을 반드시 지정해야 한다.
      ...
      1. 1번째 인자 : doInBackground() 의 parameter 로 사용
      2. 2번째 인자 : onProgressUpdate() 의 parameter 로 사용, 주로 진행상태의 Percent 값 (Integer) 로 사용된다.
      3. 3번째 인자 :doInBackground() 의 return 값이면서 onPostExecute() 의 parameter
